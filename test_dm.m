  % This code is used to test male Test dataset.
  % This is seperated so that it is more convinient while evaluating the project  
    ...
    f_d = 0.025;
    f_size = floor(f_d*fs);%
    n = length(speech1);%calculates total time of speech
    n_f = floor(n/f_size);%rounds the
    temp = 0;
    for i = 1 : n_f
    ...
    M4 =[MFCC,M1,M3];
    A1 = M4;A1 = A1.';
    words1 = [xlsread('m&f_train_SPK_2.xlsx');];
    words1 = words1.';
    z = lab_s(words1,A1);
    if z(1,1)<z(2,1)
